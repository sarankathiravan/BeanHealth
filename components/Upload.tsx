        ...
        <div className="bg-white dark:bg-slate-800 p-8 rounded-xl shadow-lg">
          <div className="text-center mb-6">
            ...
            <p className="text-slate-500 dark:text-slate-400 mt-1">
              Select a file and categorize it for analysis.
            </p>
          </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <div
                  ...
                  className={`flex-1 border-2 border-dashed rounded-lg p-8 text-center cursor-pointer transition-colors ${
                    selectedFile
                      ? "border-indigo-600 dark:border-indigo-500 bg-indigo-50 dark:bg-slate-700"
