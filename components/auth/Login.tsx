    ...
    <div className="animate-fade-in">
      ...
      <div className="space-y-6">
        <button
          ...
          disabled={loading}
          className="group relative w-full flex items-center justify-center px-6 py-4 border-2 border-slate-300 dark:border-slate-600 rounded-xl shadow-md bg-white dark:bg-slate-800 text-base font-semibold text-slate-700 dark:text-slate-200 hover:bg-slate-50 dark:hover:bg-slate-700 hover:border-sky-400 dark:hover:border-sky-500 hover:shadow-lg hover:scale-105 active:scale-95 focus:outline-none focus:ring-2 focus:ring-sky-500 focus:ring-offset-2 dark:focus:ring-offset-slate-900 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100 transition-all duration-200"
        >
